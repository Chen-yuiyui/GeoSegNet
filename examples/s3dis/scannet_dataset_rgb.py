...
class ScannetDataset(torch_data.Dataset):
    def __init__(self, root=None, npoints=10240, split='train', with_dropout=False, with_norm=False, with_rgb=False, sample_rate=None,training=False,jitter=0.4):
        super().__init__()
